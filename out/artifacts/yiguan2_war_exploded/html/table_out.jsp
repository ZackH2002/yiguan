    ...
    <script>
        function deleteInfo(val) {
            ...
            if (r === true) {
                ...
                window.location.replace("/DepositoryServlet?caozuo=deleteExit&id="+val);
...
<div>
    ...
    <main>
        <div>
            <div id="adbt">
                <a class="xiu" href="out.jsp">增加记录</a>
                <a class="dele" href="?caozuo=exit">退出系统</a>
            </div>
            <div class="table1">
                <table>
                    <tbody>
                    ...
                    <c:forEach var="record" items="${sessionScope.listExit}">
                        <tr>
                            <td>${record.id}</td>
